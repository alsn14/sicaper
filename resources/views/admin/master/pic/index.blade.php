            ...
            <div class="card w-100">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3 w-100">
                    <div class="d-flex justify-content-start align-items-center">
                        <h5 class="mb-0">{{ __("Daftar Penanggung Jawab Ruang") }}</h5>
                    </div>
                ...
                <div class="modal fade" id="TambahData" tabindex="-1" aria-labelledby="TambahDataModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="TambahDataModalLabel">{{ __("Tambah Penanggung jawab") }}</h5>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label for="nomer" class="form-label">{{ __("Nomer Telp") }} <span class="text-danger">*</span></label>
                        ...
                        <table id="data-tabel" width="100%"  class="table table-bordered text-nowrap border-bottom dataTable no-footer dtr-inline collapsed">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">{{ __("nomer Telp") }}</th>
