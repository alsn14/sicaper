  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown" data-toggle="dropdown" >
      ...
      <div class="info font-weight-bold" style="text-transform:capitalize;">
        ...
        <div class="image">
          <img src="{{ empty(Auth::user()->image) ? asset('user.png'):asset('storage/profile/'.Auth::user()->image)}}" class="img-circle" style="width:100% !important;max-width:35px !important;aspect-ratio:1 !important;object-fit:cover !important;" id="img_profile" alt="User Image">
        </div>
      </div>
